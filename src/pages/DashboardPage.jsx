...
export const DashboardPage = ({
  ...
  const fetchDashboardData = useCallback(
    async (isBackground = false) => {
      ...
      try {
        ...
        toastError(
          "Dashboard Error",
          err?.message || "Could not load overview statistics.",
        );
      } finally {
        setIsLoading(false);
  ...
  // Safely destructure with empty object/array fallbacks
  const {
    currentMonth = {},
    changes = {},
    budgetStatus = {},
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard
          ...
          currency={currency}
          percentChange={changes?.incomePercentChange || 0}
        ...
        <StatCard
          ...
          amount={currentMonth?.expenses || 0}
          currency={currency}
          percentChange={changes?.expensePercentChange || 0}
          percentChangeLabel="vs last month"
          trendInverted={true}
        ...
        <StatCard
          title="Net Savings"
          amount={currentMonth?.savings || 0}
          currency={currency}
          percentChange={changes?.savingsPercentChange || 0}
          percentChangeLabel="vs last month"
        ...
        <StatCard
          title="Savings Rate"
          amount={currentMonth?.savingsRate || 0}
          isCurrency={false}
          suffix="%"
          subtitle={
            (currentMonth?.savingsRate || 0) >= 30
              ? "Excellent (Goal: >20%)"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        <div className="lg:col-span-7 space-y-6 flex flex-col justify-between">
          ...
          <BudgetProgressCard
            ...
            percentUsed={budgetStatus?.percentUsed || 0}
            currency={currency}
