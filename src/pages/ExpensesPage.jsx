...
export const ExpensesPage = () => {
  ...
  const handleFormSubmit = async (formData) => {
    if (editingExpense) {
      ...
      success('Expense Recorded', `Added new expense for ${formData.description}`);
    }
      ...
      <div className="flex items-center justify-between pb-2 border-b border-[#222224]">
        <div>
          ...
          <p className="text-xs text-zinc-400 mt-0.5">
            Monitor and organize all outgoings, household bills, and daily spending
          </p>
        </div>
      </div>
