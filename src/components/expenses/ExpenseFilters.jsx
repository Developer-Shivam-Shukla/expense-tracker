...
import { EXPENSE_CATEGORY_LIST } from '../../utils/categories';
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            placeholder="Search description, store, category, notes..."
            className="w-full pl-9 pr-4 py-2 bg-[#111112] border border-[#2d2d30] rounded-xl text-sm text-zinc-100 placeholder-zinc-500 focus:outline-hidden focus:ring-1 focus:ring-rose-500/50 focus:border-rose-500 transition-all"
          />
        </div>
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <button
            type="button"
            onClick={onAddNew}
            className="px-4 py-2 text-xs font-semibold text-white bg-rose-600 hover:bg-rose-500 active:bg-rose-700 rounded-xl transition-all flex items-center gap-1.5 whitespace-nowrap shadow-xs"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2.5 pt-2 border-t border-[#222224] text-xs">
        ...
        <div>
          <select
            ...
            className="w-full px-3 py-2 bg-[#111112] border border-[#2d2d30] rounded-xl text-zinc-200 focus:outline-hidden focus:ring-1 focus:ring-rose-500/50"
          >
